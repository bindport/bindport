-- Registry schema shipped by BindPort v0.3.0 and v0.4.0 (user_version = 6).
CREATE TABLE leases (
...
INSERT INTO leases VALUES (
    ...
    '127.0.0.1', 'active.localhost', 'http://active.localhost', 'active',
...
INSERT INTO leases VALUES (
    ...
    'http://stopped.localhost', 'stopped', '2026-01-01T00:01:00Z',
