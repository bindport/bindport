...
otherwise scans from a stable identity-based offset. Do not claim package
metadata inference, allocation retry, or full process conflict diagnostics work
until those slices are implemented and verified.
