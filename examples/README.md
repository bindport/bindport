...
The examples include service env templates, route hostname metadata, and the
optional local dashboard settings: loopback bind, preferred dashboard port,
allowed Host headers, and token-env based auth.
