-- Registry schema shipped by BindPort v0.2.0 (PRAGMA user_version = 3).
CREATE TABLE leases (
...
INSERT INTO leases VALUES (
    ...
    'v1:migration-active', 29101, '127.0.0.1',
    'active.localhost', 'http://active.localhost', 'active',
...
INSERT INTO leases VALUES (
    ...
    29102, '127.0.0.1', 'stopped.localhost',
    'http://stopped.localhost', 'stopped',
