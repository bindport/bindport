-- Registry schema shipped by v0.7.0 and current main (user_version = 9).
CREATE TABLE leases (
...
CREATE INDEX output_files_output_path_idx ON output_files(output_name, output_scope, rendered_path);
...
INSERT INTO output_files VALUES (
    301, 'traefik', 'fixture-scope', 'v1:migration-active',
    __ROOT__ || '/outputs/active.yml', __ROOT__ || '/outputs', __ROOT__,
    __ROOT__ || '/active', 'active-hash', 'rendered', NULL,
    'active-content', 'template-v1', 101, 201,
    '2026-01-01T00:03:00Z', '2026-01-01T00:03:00Z'
);
INSERT INTO output_files VALUES (
    302, 'caddy', 'fixture-scope', 'v1:migration-stopped',
    __ROOT__ || '/outputs/stopped.caddy', __ROOT__ || '/outputs', __ROOT__,
    __ROOT__ || '/stopped', 'stopped-hash', 'error', 'external_modified',
